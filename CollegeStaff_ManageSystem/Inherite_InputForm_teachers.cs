...
namespace CollegeStaff_ManageSystem
{
    public partial class InputData_teachers : Base_InputForm_subjects
    {
        ...
        {   //some validation need to be here
            string query = $@"INSERT INTO teachers (name, lastName, otherName, address, position, subject, characteristic, workHours) 
                            VALUES 
                            ('{textBox1.Text}', '{textBox2.Text}', '{textBox3.Text}', '{textBox4.Text}', '{textBox5.Text}', '{textBox6.Text}', '{textBox8.Text}',{maskedTextBox1.Text});";
